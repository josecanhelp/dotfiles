...
class ModeVisualLine extends Mode_1.Mode {
    constructor() {
        super();
        ...
        this.maps = [
            ...
            { keys: '{N} {motion}', actions: [MoveCursor_1.ActionMoveCursor.byMotions], args: { isVisualLineMode: true } },
            ...
            { keys: 'backspace', actions: [Delete_1.ActionDelete.byLines], args: { shouldYank: true } },
            { keys: 'delete', actions: [Delete_1.ActionDelete.byLines], args: { shouldYank: true } },
            ...
            { keys: 'p', actions: [Replace_1.ActionReplace.selectionsWithRegister], args: {
                    shouldYank: true,
                    isLinewise: true,
                } },
            { keys: 'P', actions: [Replace_1.ActionReplace.selectionsWithRegister], args: {
            ...
            { keys: '<', actions: [Indent_1.ActionIndent.decrease], args: { isVisualLineMode: true } },
            { keys: '>', actions: [Indent_1.ActionIndent.increase], args: { isVisualLineMode: true } },
